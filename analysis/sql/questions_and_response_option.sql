...
DECLARE
    ...
    v_cat_economia          INT;
    v_cat_paz               INT;
    v_cat_corrupcion        INT;
    v_cat_agraria           INT;
    v_cat_transformacion    INT;
    v_cat_empresas          INT;
    v_cat_educacion         INT;
    v_cat_infraestructura   INT;
    v_cat_territorio        INT;
    v_cat_naturaleza        INT;
    v_cat_hidrocarburos     INT;
    v_cat_energia           INT;
    v_cat_politica_ext      INT;
    v_cat_tecnologia        INT;

    -- ID temporal para cada pregunta insertada
    v_question_id INT;
BEGIN
    -- ============================================================
    -- Cargar IDs en variables (una sola vez)
    -- ============================================================
    SELECT id INTO v_test_id              FROM tests      WHERE title = '¿Quién es tu candidato ideal?';

    SELECT id INTO v_cat_seguridad        FROM categories WHERE name = 'Seguridad';
    SELECT id INTO v_cat_salud            FROM categories WHERE name = 'Salud';
    SELECT id INTO v_cat_economia         FROM categories WHERE name = 'Economía';
    SELECT id INTO v_cat_paz              FROM categories WHERE name = 'Paz';
    SELECT id INTO v_cat_corrupcion       FROM categories WHERE name = 'Corrupción';
    SELECT id INTO v_cat_agraria          FROM categories WHERE name = 'Agraria';
    SELECT id INTO v_cat_transformacion   FROM categories WHERE name = 'Tranformación social';
    SELECT id INTO v_cat_empresas         FROM categories WHERE name = 'Empresas';
    SELECT id INTO v_cat_educacion        FROM categories WHERE name = 'Educación';
    SELECT id INTO v_cat_infraestructura  FROM categories WHERE name = 'Infraestructura';
    SELECT id INTO v_cat_territorio       FROM categories WHERE name = 'Territorio, regiones y descentralización';
    SELECT id INTO v_cat_naturaleza       FROM categories WHERE name = 'Naturaleza';
    SELECT id INTO v_cat_hidrocarburos    FROM categories WHERE name = 'Hidrocarburos';
    SELECT id INTO v_cat_energia          FROM categories WHERE name = 'Energia';
    SELECT id INTO v_cat_politica_ext     FROM categories WHERE name = 'Política exterior';
    SELECT id INTO v_cat_tecnologia       FROM categories WHERE name = 'Tecnología';
    ...
    VALUES (v_test_id, v_cat_seguridad,
    ...
    (v_question_id, 'Muy de acuerdo',     -1,   NOW(), NOW()),
    (v_question_id, 'De acuerdo',         -0.5, NOW(), NOW()),
    (v_question_id, 'Neutral',             0,   NOW(), NOW()),
    (v_question_id, 'En desacuerdo',       0.5, NOW(), NOW()),
    (v_question_id, 'Muy en desacuerdo',   1,   NOW(), NOW());
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_economia,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_corrupcion,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_agraria,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_transformacion,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_empresas,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_educacion,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_infraestructura,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_territorio,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_naturaleza,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_hidrocarburos,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_energia,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_politica_ext,
    ...
    -- ============================================================
    INSERT INTO questions (test_id, category_id, title, type_question, question_order, is_active, created_at, updated_at)
    VALUES (v_test_id, v_cat_tecnologia,
